...
class faculty_of_AgricPage extends StatefulWidget {
  const faculty_of_AgricPage({super.key});

  @override
  State<faculty_of_AgricPage> createState() => _faculty_of_AgricPageState();
}

class _faculty_of_AgricPageState extends State<faculty_of_AgricPage> {
  ...
  String name1 = 'Senate';
  String name = Constant.FacultyOfAdministration;
  String nameVote = 'Faculty of AdministrationVote';
