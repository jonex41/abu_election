...
class faculty_of_ArtsPage extends StatefulWidget {
  const faculty_of_ArtsPage({super.key});

  @override
  State<faculty_of_ArtsPage> createState() => _faculty_of_ArtsPageState();
}

class _faculty_of_ArtsPageState extends State<faculty_of_ArtsPage> {
  ...
  String name1 = 'Senate';
  String name = Constant.FacultyOfArts;
  String nameVote = 'Faculty of ArtsVote';
