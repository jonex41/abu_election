...
class abuBussinessSchool extends StatefulWidget {
  const abuBussinessSchool({super.key});

  @override
  State<abuBussinessSchool> createState() => _abuBussinessSchoolState();
}

class _abuBussinessSchoolState extends State<abuBussinessSchool> {
  ...
  String name1 = 'Senate';
  String name =   Constant.ABUBusinessSchool;
  String nameVote = 'ABU Bussiness SchoolVote';
