...
class napriPage extends StatefulWidget {
  const napriPage({super.key});

  @override
  State<napriPage> createState() => _napriPageState();
}

class _napriPageState extends State<napriPage> {
  ...
  String name = Constant.Napri;
  String nameVote = 'NAPRIVote';
