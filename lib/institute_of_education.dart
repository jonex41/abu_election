...
class institute_of_EducationPage extends StatefulWidget {
  const institute_of_EducationPage({super.key});

  @override
  State<institute_of_EducationPage> createState() =>
      _institute_of_EducationPageState();
}

class _institute_of_EducationPageState
    extends State<institute_of_EducationPage> {
  ...
  String name1 = 'Senate';
  String name = Constant.InstituteEducation;
  String nameVote = 'Institute of EducationVote';
