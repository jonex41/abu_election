...
class iarPage extends StatefulWidget {
  const iarPage({super.key});

  @override
  State<iarPage> createState() => _iarPageState();
}

class _iarPageState extends State<iarPage> {
  ...
  String name1 = 'Senate';
  String name = 'Institute For Agriculture Research';
  String nameVote = 'Institute For Agriculture ResearchVote';
