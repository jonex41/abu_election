...
class faculty_of_EnviromentalDesignPage extends StatefulWidget {
  const faculty_of_EnviromentalDesignPage({super.key});

  @override
  State<faculty_of_EnviromentalDesignPage> createState() =>
      _faculty_of_EnviromentalDesignPageState();
}

class _faculty_of_EnviromentalDesignPageState
    extends State<faculty_of_EnviromentalDesignPage> {
  ...
  String name = Constant.FacultyEnvironmentalDesign;
  String nameVote = 'Faculty of Enviromental DesignVote';
