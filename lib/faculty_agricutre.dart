...
class faculty_Agriculture extends StatefulWidget {
  const faculty_Agriculture({super.key});

  @override
  State<faculty_Agriculture> createState() => _faculty_AgricultureState();
}

class _faculty_AgricultureState extends State<faculty_Agriculture> {
  ...
  String name1 = 'Senate';
  String name = Constant.FacultyOfAgriculture;
  String nameVote = 'Faculty of AgricultureVote';
