...
class faculty_of_EducationPage extends StatefulWidget {
  const faculty_of_EducationPage({super.key});

  @override
  State<faculty_of_EducationPage> createState() =>
      _faculty_of_EducationPageState();
}

class _faculty_of_EducationPageState extends State<faculty_of_EducationPage> {
  ...
  String name = Constant.FacultyOfEducation;
  String nameVote = 'Faculty of EducationVote';
