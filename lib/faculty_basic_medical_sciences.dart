...
class faculty_of_basics_medicine_SciencesPage extends StatefulWidget {
  const faculty_of_basics_medicine_SciencesPage({super.key});

  @override
  State<faculty_of_basics_medicine_SciencesPage> createState() =>
      faculty_of_basics_medicine_SciencesPageState();
}

class faculty_of_basics_medicine_SciencesPageState
    extends State<faculty_of_basics_medicine_SciencesPage> {
  ...
  String name1 = 'Senate';
  String name = Constant.FacultyBasicMedicalSciences;
  String nameVote = 'Faculty of Basic Medical SciencessVote';
