...
class faculty_of_Clinical_SciencesPage extends StatefulWidget {
  const faculty_of_Clinical_SciencesPage({super.key});

  @override
  State<faculty_of_Clinical_SciencesPage> createState() =>
      _faculty_of_Clinical_SciencesPageState();
}

class _faculty_of_Clinical_SciencesPageState
    extends State<faculty_of_Clinical_SciencesPage> {
  ...
  String name1 = 'Senate';
  String name = Constant.FacultyClinicalSciences;
  String nameVote = 'Faculty of Clinical SciencesVote';
