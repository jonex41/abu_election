...
class faculty_of_Socail_SciencesPage extends StatefulWidget {
  const faculty_of_Socail_SciencesPage({super.key});

  @override
  State<faculty_of_Socail_SciencesPage> createState() =>
      _faculty_of_Socail_SciencesPageState();
}

class _faculty_of_Socail_SciencesPageState
    extends State<faculty_of_Socail_SciencesPage> {
  ...
  String name = Constant.FacultySocialSciences;
  String nameVote = 'Faculty of Social SciencesVote';
