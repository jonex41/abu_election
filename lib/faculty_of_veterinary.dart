...
class faculty_Veternary extends StatefulWidget {
  const faculty_Veternary({super.key});

  @override
  State<faculty_Veternary> createState() => _faculty_VeternaryState();
}

class _faculty_VeternaryState extends State<faculty_Veternary> {
  ...
  String name1 = 'Senate';
  String name = Constant.FacultyVeterinaryMedicine;
  String nameVote = 'Faculty of Veterinary MedicineVote';
