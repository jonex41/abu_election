...
class GoverningCouncil extends StatefulWidget {
  const GoverningCouncil({super.key});

  @override
  State<GoverningCouncil> createState() => _GoverningCouncilState();
}

class _GoverningCouncilState extends State<GoverningCouncil> {
  ...
  //String name1 = 'senate';
  String name = Constant.GoverningCouncil;
  String nameVote = 'Governing CouncilVote';
