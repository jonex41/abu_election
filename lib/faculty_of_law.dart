...
class faculty_of_LawPage extends StatefulWidget {
  const faculty_of_LawPage({super.key});

  @override
  State<faculty_of_LawPage> createState() => _faculty_of_LawPageState();
}

class _faculty_of_LawPageState extends State<faculty_of_LawPage> {
  ...
  String name = Constant.FacultyOfLaw;
  String nameVote = 'Faculty of LawVote';
