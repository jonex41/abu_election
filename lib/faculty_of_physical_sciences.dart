...
class faculty_ofphysical_sciencesPage extends StatefulWidget {
  const faculty_ofphysical_sciencesPage({super.key});

  @override
  State<faculty_ofphysical_sciencesPage> createState() =>
      _faculty_ofphysical_sciencesPageState();
}

class _faculty_ofphysical_sciencesPageState
    extends State<faculty_ofphysical_sciencesPage> {
  ...
  String name = Constant.FacultyPhysicalSciences;
  String nameVote = 'Faculty of Physical SciencesVote';
