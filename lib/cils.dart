...
class cilsPage extends StatefulWidget {
  const cilsPage({super.key});

  @override
  State<cilsPage> createState() => _cilsPageState();
}

class _cilsPageState extends State<cilsPage> {
  ...
  String name1 = 'Senate';
  String name = Constant.CILS;
  String nameVote = 'CILSVote';
