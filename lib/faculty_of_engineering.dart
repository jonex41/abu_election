...
class faculty_of_EngineeringPage extends StatefulWidget {
  const faculty_of_EngineeringPage({super.key});

  @override
  State<faculty_of_EngineeringPage> createState() =>
      _faculty_of_EngineeringPageState();
}

class _faculty_of_EngineeringPageState
    extends State<faculty_of_EngineeringPage> {
  ...
  String name1 = 'Senate';
  String name = Constant.FacultyOfEngineering;
  String nameVote = 'Faculty of EngineeringVote';
