...
class faculty_of_Allied_Health_SciencesPage extends StatefulWidget {
  const faculty_of_Allied_Health_SciencesPage({super.key});

  @override
  State<faculty_of_Allied_Health_SciencesPage> createState() =>
      _faculty_of_Allied_Health_SciencesPageState();
}

class _faculty_of_Allied_Health_SciencesPageState
    extends State<faculty_of_Allied_Health_SciencesPage> {
  ...
  String name1 = 'Senate';
  String name = Constant.FacultyAlliedHealthSciences;
  String nameVote = 'Faculty of Allied Health SciencesVote';
