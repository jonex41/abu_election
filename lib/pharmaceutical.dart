...
class pharmaceuticalPage extends StatefulWidget {
  const pharmaceuticalPage({super.key});

  @override
  State<pharmaceuticalPage> createState() => _pharmaceuticalPageState();
}
...
class _pharmaceuticalPageState extends State<pharmaceuticalPage> {
  ...
  String name = Constant.FacultyPharmaceuticalSciences;
  String nameVote = 'Faculty of Pharmaceutical SciencesVote';
